...
const AllCities = () => {
  ...
  const { cities, cityMoreDetail, topCities } = useSelector(
    (state) => state.city
  );
  console.log(topCities,'topCities');
  // console.log(citiesDetail,'citiesDetail');
  ...
  const handleDeleteCity = (id) => {
    ...
    dispatch(deleteCity(id)).then(() => {
      dispatch(getAllCities());
      dispatch(getCityMoreDetail());
    }
      ...
      
      {
        ...
        Cell: ({ row: { original } }) => (
          <div className="flex gap-2">
            <button onClick={() => handleDeleteCity(original.actions)}>
              <MdDeleteForever
                size={38}
  ...
  return (
    <div
      className="shadow-3xl px-7 py-4  bg-theme-bg text-slate-300 rounded-2xl"
      id="divToPrint"
    >
      <div className="">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3  items-center gap-2  rounded-lg w-full ">
            ...
            <h3 className="p-10 flex flex-col md:flex-row justify-between h-full bg-theme-bg2 rounded-lg">
              <div className="flex flex-col">
                ...
                <span className="font-bold text-4xl text-color-primary">
                  {cityMoreDetail?.mostPopulatedCity[0]?.name}
              ...
              <h3 className="flex flex-col ">
                Products{" "}
                <span className="font-bold text-4xl text-color-primary">
                  {cityMoreDetail?.mostPopulatedCity[0]?.products}
                </span>
              </h3>
            </h3>
            <h3 className="p-10 flex flex-col h-full bg-theme-bg2 rounded-lg">
              ...
              <span className="font-bold text-4xl text-color-primary">
                {cityMoreDetail?.recentlyAddedCity?.name}
              </span>
            </h3>
            {/* <h3>
      ...
      <>
        <div className="flex flex-col gap-4  md:flex-row md:justify-between mt-10 md:items-center">
          ...
          <div>
            ...
            >
              <TbCategoryPlus size={22} /> Add City
            </Link>
          </div>
        </div>

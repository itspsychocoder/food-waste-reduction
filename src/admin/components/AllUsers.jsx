...
const AllUsers = () => {
  ...
  return (
    <div className=" px-7 py-4 w-full  bg-theme-bg2 text-slate-300 rounded-2xl ">
      <h2 className="s text-white font-bold text-xl border-b border-border-info-color pb-3 mb-5 ">
        Users
      </h2>
        ...
        <div className="mt-12 ">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            >
              ...
              <option value="paymentVerified">Status</option>
            </select>
            <input

...
const Sidebar = ({ closeNavbar }) => {
  ...
  console.log(location.pathname, "location.pathname in sidebar..........,,,,,,..");
  console.log(activeLink, "activeLink in sidebar..........,,,,,,..");
  ...
  return (
    <div className="w-full hidden sm:block lg:sticky top-5 lg:h-screen lg:w-[25%] sm:min-w-[250px] lg:max-w-[280px]  ">
      <div className="text-white  bg-theme-bg2 p-5 rounded-2xl  ">
          ...
          <li>
            ...
            >
              <MdLocationCity
                size={18}
                className={`text-theme-color transition-all duration-500 ${
                  activeLink === "/admin/cities" ? " text-white" : ""
                }`}
              />
              Cities
            </Link>
          ...
          {/* <li>
            ...
            >
              <MdLocationCity
                size={18}
                className={`text-theme-color transition-all duration-500 ${
                  activeLink === "/admin/orders" ? " text-white" : ""
                }`}
              />
              Orders
            </Link>
